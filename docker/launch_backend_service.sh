...
# Unset DOTNET_SYSTEM_GLOBALIZATION_INVARIANT to enable ICU support for Aspose.Slides (PPT parsing)
# This is needed because Aspose.Slides requires full ICU support to work properly
